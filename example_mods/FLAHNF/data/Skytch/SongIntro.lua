--easy script configs
IntroTextSize = 26	--Size of the text for the Estas Jugandothing.
...
function onCreate()
	...
	makeGraphic('JukeBoxTag', 300+IntroTagWidth, 175, IntroTagColor)
	setObjectCamera('JukeBoxTag', 'other')
	addLuaSprite('JukeBoxTag', true)

	--the box
	makeLuaSprite('JukeBox', 'empty', -305-IntroTagWidth, 15)
	makeGraphic('JukeBox', 300, 175, '000000')
	setObjectCamera('JukeBox', 'other')
	addLuaSprite('JukeBox', true)
	
	--the text for the "Estas Jugando" bit
	makeLuaText('JukeBoxText', "MagiciansWRLD & \nSemicola Games", 300, -305-IntroTagWidth, 30)
	...
	makeLuaText('JukeBoxSubText', "Skytch - Skxtch Vocal Remix", 300, -305-IntroTagWidth, 90)
