...
function onCreate()
	...
	makeLuaText('JukeBoxText', "Lofi Funkin' Team", 300, -305-IntroTagWidth, 30)
	...
	makeLuaText('JukeBoxSubText', "Random Tomfuckery - Twilight Serenade - TheEddRemix", 300, -305-IntroTagWidth, 60)
