...
function onCreate()
	...
	--THE TOP BAR
	makeLuaSprite('UpperBar', 'empty', 0, -250)
	...
	--THE BOTTOM BAR
	makeLuaSprite('LowerBar', 'empty', 0, 850)
...
function onUpdate()
	...
	noteTweenY('NOTEMOVE1', 0, 2000, Speed, 'Linear')	
	noteTweenY('NOTEMOVE2', 1, 2000, Speed, 'Linear')
	noteTweenY('NOTEMOVE3', 2, 2000, Speed, 'Linear')
	noteTweenY('NOTEMOVE4', 3, 2000, Speed, 'Linear')
	noteTweenY('NOTEMOVE5', 4, 2000, Speed, 'Linear')
	noteTweenY('NOTEMOVE6', 5, 2000, Speed, 'Linear')
	noteTweenY('NOTEMOVE7', 6, 2000, Speed, 'Linear')
	noteTweenY('NOTEMOVE8', 7, 2000, Speed, 'Linear')
